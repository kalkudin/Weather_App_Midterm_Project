...
import com.example.midtermproject.weather_feature.presentation.model.WeatherDayDetails

class WeatherWeekDayRecyclerAdapter : ListAdapter<WeatherDayDetails, WeatherWeekDayRecyclerAdapter.WeatherDayViewHolder>(WeatherDayDiffCallback()) {
